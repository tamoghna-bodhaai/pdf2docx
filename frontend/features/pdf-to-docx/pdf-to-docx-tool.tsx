...
export function PdfToDocxTool({ config, restoredJob, onOpen }: { config: ConfigDto; restoredJob?: JobDto; onOpen: (job: JobDto) => void }) {
  ...
  const jobs = batch.data?.jobs ?? uploadedJobs;
