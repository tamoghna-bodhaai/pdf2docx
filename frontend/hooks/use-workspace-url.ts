...
export type Tool = "pdf-to-docx" | "images-to-pdf" | "split-pdf";
export type DockPanel = "setup" | "files" | "conversions" | "history";
const TOOLS = new Set<Tool>(["pdf-to-docx", "images-to-pdf", "split-pdf"]);
const PANELS = new Set<DockPanel>(["setup", "files", "conversions", "history"]);
